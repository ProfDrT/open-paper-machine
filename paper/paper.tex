...
\begin{table}[t]
\centering
\caption{Skill engine summary. Each engine is a single \texttt{SKILL.md} file encoding domain expertise as structured natural language instructions. Total knowledge base: approximately 5,300 lines of Markdown across 14 engines.}
\label{tab:engines}
...
\textbf{DP2: Skill Modularity.} \emph{Domain expertise should be encapsulated in modular, independently maintainable skill engines that the LLM loads on demand.} The fourteen-engine architecture separates concerns, enabling domain experts to contribute knowledge to specific engines without understanding the full system, and supporting recomposition for different use cases.
